...
alias thenv='cd && cd amir/Thesis && source thenv/bin/activate'
alias  fenv='cd && cd amir/fun    && source  fenv/bin/activate'
alias  genv='cd && cd amir/ugent  && source genv/bin/activate'
alias renv='cd && cd amir/work/radar && source renv/bin/activate'
