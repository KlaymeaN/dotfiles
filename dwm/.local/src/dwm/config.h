...
static char *fonts[]          = { "monospace:size=20", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=20", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Key keys[] = {
 ...
 /*	{ MODKEY|ShiftMask,		XK_b,          spawn,                  SHCMD("") }, */
  ...
  { MODKEY, XK_m    ,       spawn,    SHCMD("~/.local/bin/mic_toggle.sh") } , 
